...
namespace BetaMart2
{
    public partial class Form1 : Form
    {
        ...
        private void dataGridView_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                if (MessageBox.Show("Yakin akan menghapus ?", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes);
        ...
        {
            if (MessageBox.Show("Yakin ingin menghapus ?", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes);
            barangBindingSource.RemoveCurrent();
        }

        private void btnDeleteAll_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Yakin ingin menghapus semua ?", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes) ;
